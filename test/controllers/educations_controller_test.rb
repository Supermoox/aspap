...
class EducationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post educations_url, params: { education: { field: @education.field, institution: @education.institution, qualification_id: @education.qualification_id, yearCompleted: @education.yearCompleted } }
    end
  ...
  test "should update education" do
    patch education_url(@education), params: { education: { field: @education.field, institution: @education.institution, qualification_id: @education.qualification_id, yearCompleted: @education.yearCompleted } }
